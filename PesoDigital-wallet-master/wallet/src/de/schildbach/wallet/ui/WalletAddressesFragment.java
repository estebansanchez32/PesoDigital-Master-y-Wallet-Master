    ...
    public void onListItemClick(final ListView l, final View v, final int position, final long id) {
        activity.startActionMode(new ActionMode.Callback() {
            ...
            private void handleShowQr(final Address address) {
                final String uri = PesoDigitalURI.convertToPesoDigitalURI(address, null, viewModel.ownName.getValue(), null);
                BitmapFragment.show(getFragmentManager(), Qr.bitmap(uri));
            }

            private void handleCopyToClipboard(final Address address) {
                clipboardManager.setPrimaryClip(ClipData.newPlainText("PesoDigital address", address.toBase58()));
