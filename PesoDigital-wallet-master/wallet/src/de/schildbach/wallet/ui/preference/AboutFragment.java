...
public final class AboutFragment extends PreferenceFragment {
    ...
    private static final String KEY_ABOUT_CREDITS_PesoDigitalJ = "about_credits_PesoDigitalj";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        findPreference(KEY_ABOUT_CREDITS_PesoDigitalJ)
                .setTitle(getString(R.string.about_credits_PesoDigitalj_title, VersionMessage.PesoDigitalJ_VERSION));
    }
}
