...
public final class WalletAddressFragment extends Fragment {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        viewModel.PesoDigitalUri.observe(this, new Observer<Uri>() {
            ...
            public void onChanged(final Uri PesoDigitalUri) {
                ...
                if (nfcAdapter != null)
                    nfcAdapter.setNdefPushMessage(createNdefMessage(PesoDigitalUri.toString()), activity);
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        currentAddressQrView = (ImageView) view.findViewById(R.id.PesoDigital_address_qr);

        currentAddressQrCardView = (CardView) view.findViewById(R.id.PesoDigital_address_qr_card);
