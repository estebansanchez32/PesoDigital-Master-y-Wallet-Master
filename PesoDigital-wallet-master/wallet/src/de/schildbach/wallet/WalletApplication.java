...
import org.PesoDigitalj.core.VersionMessage;
import org.PesoDigitalj.crypto.LinuxSecureRandom;
import org.PesoDigitalj.crypto.MnemonicCode;
...
import org.PesoDigitalj.wallet.WalletFiles;
...
public class WalletApplication extends Application {
    ...
    public void onCreate() {
        ...
        org.PesoDigitalj.core.Context.enableStrictMode();
        ...
        Threading.uncaughtExceptionHandler = new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(final Thread thread, final Throwable throwable) {
                log.info("PesoDigitalj uncaught exception", throwable);
