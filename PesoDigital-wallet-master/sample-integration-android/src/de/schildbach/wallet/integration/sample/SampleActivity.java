...
public class SampleActivity extends Activity {
    ...
    private void handleDonate() {
        ...
        PesoDigitalIntegration.requestForResult(SampleActivity.this, REQUEST_CODE, addresses[0]);
    }
    ...
    private void handleRequest() {
        try {
            ...
            PesoDigitalIntegration.requestForResult(SampleActivity.this, REQUEST_CODE,
    ...
    protected void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                final String txHash = PesoDigitalIntegration.transactionHashFromResult(data);
                if (txHash != null) {
                    ...
                    if (PesoDigitalIntegration.paymentFromResult(data) != null)
